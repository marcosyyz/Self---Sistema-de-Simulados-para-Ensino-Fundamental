...
<head>		
                <EMBED SRC="../sons/queda.wav" HIDDEN="TRUE" AUTOSTART="TRUE"></EMBED>
                <meta charset="utf8">                 
		...
		<!--<script src="//ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script> -->
                ...
                <link rel="stylesheet" type="text/css" href="<?php echo ROOT_URL ?>view/css/animation2.css" />		
		<link rel="stylesheet" type="text/css" href="<?php echo ROOT_URL ?>view/css/estilo.css" />
		...
		<link rel="stylesheet" type="text/css" href="<?php echo ROOT_URL ?>view/css/dialog-ricky.css" />
                ...
                <!-- *******************   scripts   ********************************* -->
		<script src="<?php echo ROOT_URL ?>view/js/modernizr.custom.js"></script>
		<script src="<?php echo ROOT_URL ?>view/js/classie.js"></script>
		<script src="<?php echo ROOT_URL ?>view/js/dialogFx.js"></script>		
